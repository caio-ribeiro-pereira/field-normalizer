...
/**
 * Factory method which transforms all object fields based on cast string
 *
 * @param {Object} object
 * @param {String} cast
...
const transform = (object, cast, native = false) => {
  if (isValidObject(object) && isValidFunction(cast)) {
 ...
 * @public
 */
const toLowerCase = (object) => transform(object, FUNCTIONS.toLowerCase, true);
 ...
 * @public
 */
const toUpperCase = (object) => transform(object, FUNCTIONS.toUpperCase, true);
